  ...
  return (
    <div className="App" ref={currNode}>
      <header className="App-header">
        ...
        <h1 style={{ lineHeight: '1px' }}>Create Amazing Account For <a href='https://astral.ninja'>Nostr</a></h1>
        <div className='desc'><p>1. Create a cool address as: 66666.....cccccc</p> 
          <p>2. Press F12, select Console to view the details</p>
          <p>3. The more identical characters, it takes longer</p>
          <p>4. No Trust. You can execute when closing the network. Open Source on <a href='https://github.com/shanelau/nostr-get-luck-account'>Github</a></p>
